  ...
  const menus = [
    {
      ...
      childrens: [
          ...
          childrens: [
            {
              nama: "Pria",
              click: () =>
                handleFilter("Pria", "gender", setData, "memberLaundry"),
            },
            {
              nama: "Wanita",
              click: () =>
                handleFilter("Wanita", "gender", setData, "memberLaundry"),
            },
          ],
        },
        {
          ...
          childrens: [
            {
              nama: "Owner",
              click: () =>
                handleFilter("Owner", "jabatan", setData, "memberLaundry"),
            },
            {
              nama: "Kasir",
              click: () =>
                handleFilter("Kasir", "jabatan", setData, "memberLaundry"),
            },
            {
              nama: "Tenaga Cuci",
              click: () =>
        ...
        },
        {
          nama: "- Default Filter -",
          click: () =>
            handleFilter("Default", "gender", setData, "memberLaundry"),
        },
      ],
    },
    {
